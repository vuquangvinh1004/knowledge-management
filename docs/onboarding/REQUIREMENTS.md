...
Hãy đọc [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md), [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md) và [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md) trước khi code. Dựa trên kiến trúc đã chốt, hãy bắt đầu Phase 1 bằng cách:
