...
### 2.1. [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md)
...
### 2.2. [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md)
...
### 2.3. [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md)
...
### 2.4. [`PKM_SPEC_FINAL.md`](../spec/PKM_SPEC_FINAL.md)
...
### 2.5. [`REQUIREMENTS.md`](./REQUIREMENTS.md)
...
1. Đọc [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md)
2. Đọc [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md)
3. Đọc [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md)

### Nếu task liên quan đến UI hoặc workflow người dùng

Ngoài 3 file trên, phải đọc thêm [`PKM_SPEC_FINAL.md`](../spec/PKM_SPEC_FINAL.md).

### Nếu task liên quan đến schema hoặc dữ liệu

Phải đọc kỹ:

- phần data model trong [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md)
- migration policy
- local file layout
...
Đọc thêm [`REQUIREMENTS.md`](./REQUIREMENTS.md) để giữ đúng bối cảnh và build order.
...
- [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md) là file khởi động ngắn gọn
- [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md) là nguồn chân lý về kiến trúc và nguyên tắc lõi
- [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md) là nguồn chân lý về tiến độ và trạng thái phát triển
- [`PKM_SPEC_FINAL.md`](../spec/PKM_SPEC_FINAL.md) là nguồn chân lý về mục tiêu chức năng và UX
- [`REQUIREMENTS.md`](./REQUIREMENTS.md) là prompt ngắn để khởi động agent nhanh

Nếu có xung đột giữa README này và ARCHITECTURE, ưu tiên theo [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md).

Nếu có xung đột giữa trạng thái thực tế và ROADMAP, phải cập nhật [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md).
...
- báo kết quả test
- báo rủi ro còn lại
- cập nhật [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md)
- cập nhật changelog trong [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md) nếu task làm thay đổi kiến trúc, schema, rule hoặc cấu trúc dự án

### 4.3. Khi nào cần cập nhật ARCHITECTURE

Phải cập nhật [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md) nếu có thay đổi liên quan đến:
...
Phải cập nhật [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md) nếu có thay đổi liên quan đến:
...
1. [`PKM_README_PROJECT_STARTER.md`](./PKM_README_PROJECT_STARTER.md)
2. [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md)
3. [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md)
4. [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md)
5. [`PKM_SPEC_FINAL.md`](../spec/PKM_SPEC_FINAL.md)
...
1. [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md)
...
1. [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md)
2. phần liên quan trong [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md)
3. bug tracker và risk tracker trong [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md)
...
2. [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md)
3. [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md)
4. [`PKM_SPEC_FINAL.md`](../spec/PKM_SPEC_FINAL.md) nếu task liên quan đến UI hoặc workflow
5. [`REQUIREMENTS.md`](./REQUIREMENTS.md) nếu cần bắt đầu sprint mới
...
- [`PKM_README_PROJECT_STARTER.md`](./PKM_README_PROJECT_STARTER.md)
- [`START_HERE_FOR_AI_AGENT.md`](./START_HERE_FOR_AI_AGENT.md)
- [`PKM_ARCHITECTURE.md`](../architecture/PKM_ARCHITECTURE.md)
- [`PKM_ROADMAP.md`](../roadmap/PKM_ROADMAP.md)
- [`PKM_SPEC_FINAL.md`](../spec/PKM_SPEC_FINAL.md)
...
Nên giữ 6 file này trong bộ `docs/` và liên kết chúng từ `README.md` để AI Agent và người phát triển luôn nhìn thấy ngay khi mở dự án.
