...
| Architecture document | Done | Cao | `PKM_ARCHITECTURE.md` |
| Roadmap document | Done | Cao | `PKM_ROADMAP.md` |
| Spec final | Done | Cao | `PKM_SPEC_FINAL.md` |
| Starter + start files | Done | Cao | `PKM_README_PROJECT_STARTER.md`, `START_HERE_FOR_AI_AGENT.md` |
...
```text
Đọc PKM_ARCHITECTURE.md và PKM_ROADMAP.md trước khi code. Tuân thủ tech stack, cấu trúc thư mục, business rules, acceptance criteria và checklist sau mỗi task.
```
...
```text
Trước khi bắt đầu:
1. Đọc PKM_ARCHITECTURE.md
2. Đọc PKM_ROADMAP.md
...
```text
Trước khi bắt đầu:
1. Đọc PKM_ARCHITECTURE.md mục business rules, data safety và coding standards
2. Đọc PKM_ROADMAP.md mục bug tracker và risk tracker
...
```text
Trước khi bắt đầu:
1. Kiểm tra boundaries trong PKM_ARCHITECTURE.md
...
| --- | --- |
| Kiến trúc tổng thể | `PKM_ARCHITECTURE.md` |
| Business rules và extraction rules | `PKM_ARCHITECTURE.md` mục 6 |
| Schema database | `PKM_ARCHITECTURE.md` mục 7 |
| Tiến độ project | `PKM_ROADMAP.md` |
| Task ưu tiên tiếp theo | `PKM_ROADMAP.md` mục 2 và 3 |
| Bug hiện có | `PKM_ROADMAP.md` mục 5 |
| Risk kỹ thuật | `PKM_ROADMAP.md` mục 6 |
