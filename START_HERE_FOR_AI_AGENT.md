...
>
> 1. Đọc file `PKM_ARCHITECTURE.md`
> 2. Đọc file `PKM_ROADMAP.md`
...
>
> 1. `PKM_ARCHITECTURE.md`
> 2. `PKM_ROADMAP.md`
> 3. `START_HERE_FOR_AI_AGENT.md`
> 4. `PKM_SPEC_FINAL.md`
...
AI Agent phải dùng cấu trúc thư mục đã định trong `PKM_ARCHITECTURE.md`.
...
- [ ] Test đã pass
- [ ] Đã cập nhật `PKM_ROADMAP.md` nếu trạng thái phase/task thay đổi
- [ ] Đã cập nhật `PKM_ARCHITECTURE.md` nếu có đổi kiến trúc, schema, rule hoặc standard
...
```text
Đọc PKM_ARCHITECTURE.md, PKM_ROADMAP.md và START_HERE_FOR_AI_AGENT.md trước khi code.
...
3. Đọc START_HERE_FOR_AI_AGENT.md
...
Trước khi bắt đầu:
1. Đọc PKM_ARCHITECTURE.md
2. Đọc PKM_ROADMAP.md, nhất là bug tracker và risk tracker
3. Đọc START_HERE_FOR_AI_AGENT.md
